...
namespace KhosraviFlowerShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId,Title,ShortDescription,Text,Visit,ShowInSlider,Price,Image,Count,CreateDate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CategoryId,Title,ShortDescription,Text,Visit,ShowInSlider,Price,Image,Count,CreateDate")] Product product)
        {
