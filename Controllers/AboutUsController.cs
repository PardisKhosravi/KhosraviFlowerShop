...
namespace KhosraviFlowerShop.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public AboutUsController(KhosraviFlowerShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AboutId,Description")] AboutUs aboutUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AboutId,Description")] AboutUs aboutUs)
        {
